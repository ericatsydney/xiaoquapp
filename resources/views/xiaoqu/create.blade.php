      ...
      <div class="col-lg-8">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-lg-12">
                <form role="form" action="/xiaoqus" method="post">
                  {!! csrf_field() !!}
                  <div class="form-group">
                    <label>小区名</label>
                    <input class="form-control" name='title' placeholder="例：珠江帝景湾">
                  </div>
                  <div class="form-group">
                    <label>省份</label>
                  ...
                  <div class="form-group">
                    <label>城市</label>
                    <input class="form-control" placeholder="例：江门" name='city' >
                  </div>
                  <div class="form-group">
                    <label>地址</label>
                  ...
                  <div class="form-group">
                    <label>邮编</label>
                    <input class="form-control" placeholder="例：529000" name='postcode' >
                  </div>
                  <div class="row">
